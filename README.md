...
<!-- Animated Header -->
<img width="100%" src="https://capsule-render.vercel.app/api?type=venom&color=0:0a0a0a,40:0d1b2a,70:1b263b,100:415a77&height=260&section=header&text=Dushyant%20Kumar&fontSize=62&fontColor=e0e1dd&fontAlignY=40&desc=Full-Stack%20Engineer%20%E2%80%A2%20Blockchain%20Researcher%20%E2%80%A2%20Competitive%20Programmer&descAlignY=60&descSize=17&descColor=778da9&animation=fadeIn" />

<!-- Typing SVG -->
<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=22&pause=1000&color=778DA9&center=true&vCenter=true&width=700&lines=Building+products+that+people+actually+use+%F0%9F%9A%80;Blockchain+%2B+Full-Stack+%2B+AI+%3D+My+Stack;1%2C500%2B+problems+solved+and+still+going+%F0%9F%94%A5;Knight+on+LeetCode+%C2%B7+5%E2%98%85+on+HackerRank" alt="Typing SVG" />
</a>
...
**Key Highlights:**
- 🏗️ Architected end-to-end — from DB schema to UI components
- 📊 Real-time dashboards via **LeetCode + GitHub API** integrations
- ⚡ Optimized rendering with custom **React hooks & memoization**
- 📱 Fully responsive using **TailwindCSS** adaptive layouts
...
**Key Highlights:**
- 📜 Deployed **Solidity Smart Contracts** for tamper-proof cert issuance
- 🌐 **IPFS (Pinata)** for censorship-resistant decentralized storage
- 🔐 MetaMask wallet auth + ABI-powered React frontend
- 🧪 Full testnet lifecycle on **Ganache + Truffle**
...
**Key Highlights:**
- 🔐 Secure multi-role access with **JWT authentication**
- 💳 **Stripe** integration for real-time charity donations
- 🌦️ **OpenWeather API** for live crisis zone monitoring
- 📧 Automated alerts via **Nodemailer**
...
![Research](https://img.shields.io/badge/Published-ICSRI_2024-blue?style=flat-square)
...
╠══════════════╦═══════════════════════════╦══════════════════════════╣
║  Platform    ║       Achievement         ║         Level            ║
╠══════════════╬═══════════════════════════╬══════════════════════════╣
║  LeetCode    ║ 1,500+ · Rating 1825 Max  ║  🏅 Knight               ║
║  GeeksForGeeks║ 600+ Problems Solved     ║  ⭐ Advanced DSA         ║
║  HackerRank  ║ Problem Solving + Lang    ║  🥇 5-Star Gold          ║
╚══════════════╩═══════════════════════════╩══════════════════════════╝
```
...
&nbsp;
<a href="https://www.geeksforgeeks.org/profile/dushyant2026">
  <img src="https://img.shields.io/badge/GFG-600%2B_Solved-2F8D46?style=for-the-badge&logo=geeksforgeeks&logoColor=white" />
</a>
&nbsp;
<img src="https://img.shields.io/badge/HackerRank-5★_Gold-00EA64?style=for-the-badge&logo=hackerrank&logoColor=black" />
